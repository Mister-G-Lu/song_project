...
class TasteEngine:
    def __init__(self, csv_path: str = "posts_tails.csv"):
    ...
    def _init_genre_keywords(self):
        ...
        self.genre_keywords = {
            'Pop': ['pop', 'pop hit', 'pop song', 'mainstream pop'],
            'Rock': ['rock', 'rock song', 'alternative rock', 'punk rock', 'hard rock'],
            'Classical/Instrumental': ['classical', 'piano', 'orchestra', 'orchestral', 'instrumental', 'violin', 'symphony'],
            'Electronic/Dance': ['electronic', 'dubstep', 'edm', 'synth', 'electronic dance', 'techno', 'house'],
            'J-Pop/Anime': ['j-pop', 'jpop', 'vocaloid', 'hatsune', 'anime', 'japanese', 'jp'],
            'K-Pop': ['k-pop', 'kpop', 'korean'],
            'Jazz/Swing': ['jazz', 'swing', 'electro-swing', 'big band'],
            'Disco/Funk': ['disco', 'funk', 'groovy', 'groove', 'boogie'],
            'Indie/Alternative': ['indie', 'alternative indie', 'indie pop', 'indie rock'],
            'Metal': ['metal', 'heavy metal', 'symphonic metal'],
            'Rap/Hip-Hop': ['rap', 'hip hop', 'hip-hop'],
            'Folk/Acoustic': ['folk', 'acoustic', 'singer-songwriter'],
            'Eurovision': ['eurovision'],
            'Christmas/Holiday': ['christmas', 'xmas', 'holiday'],
            'Soundtrack/Score': ['soundtrack', 'theme', 'score', 'ost'],
            'R&B/Soul': ['rnb', 'r&b', 'soul', 'motown'],
            'Country': ['country'],
            'A Cappella': ['a cappella', 'acapella'],
        }
