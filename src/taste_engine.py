...
class TasteEngine:
    ...
    def _get_genre_distribution(self) -> Dict[str, Dict]:
        ...
        """
        genre_data = defaultdict(lambda: {'count': 0, 'liked_70': 0, 'liked_90': 0, 'ratings': [], 'songs': []})
        ...
        for r in self.rows:
            ...
            if rating:
                ...
                if rating >= 70:
                    genre_data[genre]['liked_70'] += 1
                if rating >= 90:
                    genre_data[genre]['liked_90'] += 1
        ...
        for genre, data in sorted(genre_data.items(), key=lambda x: -x[1]['count']):
            ...
            result[genre] = {
                'count': data['count'],
                'liked_70': data['liked_70'],
                'liked_90': data['liked_90'],
                'avg_rating': avg,
