...
GENRE_KEYWORDS: Dict[str, List[str]] = {
    ...
    'META/Other': ['battle of the', 'rating system', 'weekly roundup', 'spotify weekly',
                 'spotify', 'double review', 'rating update', 'monthly recap',
                 'compilation', 'playlist collection', 'one hit song for each',
                 'announcement', 'current listening', 'rating review', 'review round'],
}
...
CURATED_ARTIST_GENRES: Dict[str, str] = {
    ...
    # Additional artists from uncategorized analysis
    'ABBA': 'Pop', 'Abba': 'Pop', 'Chris Isaak': 'Rock', 'Elvis Presley': 'Rock',
    'Bon Jovi': 'Rock', 'Spice Girls': 'Pop', 'Fort Minor': 'Rap/Hip-Hop',
    'Dream Theater': 'Metal', 'Sly & The Family Stone': 'Disco/Funk',
    'Chappell Roan': 'Pop', 'Mori Calliope': 'J-Pop/Anime',
    'Yurima': 'Classical/Instrumental', 'fujii Kaze': 'J-Pop/Anime',
    'Alexander Rybak': 'Pop', 'SG Lewis': 'Electronic/Dance',
    'RIELL': 'Pop', 'ill peach': 'Indie/Alternative',
    'Mariya Takeuchi': 'J-Pop/Anime', 'Dodie': 'Indie/Alternative',
    'dodie': 'Indie/Alternative', 'Static-P': 'Electronic/Dance',
    'Static P': 'Electronic/Dance', 'Jenny and Tyler': 'Indie/Alternative',
    'Magic!': 'Pop', 'All Levels at Once': 'Rock',
    'Matt Burrows': 'Rock', 'Amadeus Electric Quartet': 'Classical/Instrumental',
    'Jonth': 'Electronic/Dance', 'Tom Wilson': 'Electronic/Dance',
    'Adam Lambert': 'Rock', 'Adam Hicks': 'Pop', 'Bridgit Mendler': 'Pop',
    'Naomi Scott': 'Pop', 'Hayley Kiyoko': 'Pop',
    'Ryokuoushoku Shakai': 'J-Pop/Anime', '"?5F|<AM>': 'J-Pop/Anime',
    'Hatsuki Yura': 'J-Pop/Anime', 'Yura Hatsuki': 'J-Pop/Anime',
    'Carly Rae Jepsen': 'Pop', 'Sia': 'Pop', 'Lorde': 'Indie/Alternative',
    'Bastille': 'Rock', 'Hozier': 'Indie/Alternative',
    'Of Monsters and Men': 'Indie/Alternative', 'Halsey': 'Pop',
    'Troye Sivan': 'Pop', 'Lauv': 'Pop', 'Bazzi': 'Pop',
    'Kevin Penkin': 'Soundtrack/Score', 'SawanoHiroyuki': 'Soundtrack/Score',
    'Hiroyuki Sawano': 'Soundtrack/Score', 'Yuki Kajiura': 'Soundtrack/Score',
    'Kegani': 'J-Pop/Anime', 'VIXX': 'K-Pop',
    "May'n": 'J-Pop/Anime', 'Maylyn': 'Pop',
    'Rirubi': 'J-Pop/Anime', 'Yuzuki': 'J-Pop/Anime',
    'The Lumineers': 'Indie/Alternative', 'Mumford & Sons': 'Folk/Acoustic',
    'Sly and the Family Stone': 'Disco/Funk',
    'R.E.M.': 'Rock', 'A-ha': 'Pop', 'a-ha': 'Pop',
    'Curtis Mayfield': 'R&B/Soul', 'Joan Osborne': 'Rock',
    'Dave Matthews Band': 'Rock', 'Jack Johnson': 'Folk/Acoustic',
    'Twenty One Pilots': 'Rock', 'twenty one pilots': 'Rock',
    'Car Seat Headrest': 'Indie/Alternative',
    'Magic!': 'Pop', 'Rixton': 'Pop', 'All Time Low': 'Rock',
    'Train': 'Rock', 'Hurts': 'Pop', 'One Direction': 'Pop',
    'X Ambassadors': 'Rock', 'Pendulum': 'Electronic/Dance',
    'Sheppard': 'Pop', 'Sting': 'Rock', 'Johnossi': 'Rock',
    'LÉON': 'Pop', 'Ricky Martin': 'Latin',
    'Jennifer Lopez': 'Latin', 'J Balvin': 'Latin',
    'F-777': 'Electronic/Dance', 'Alan Walker': 'Electronic/Dance',
    'Against The Current': 'Rock',
    'Pink Floyd': 'Rock', 'Dream Theater': 'Metal',
    'Dodie': 'Indie/Alternative', 'dodie': 'Indie/Alternative',
    'Jon Cozart': 'Pop', 'Carly Rae Jepsen': 'Pop',
    'Lana Del Rey': 'Pop', 'Christina Grimmie': 'Pop',
    'Bastille': 'Rock', 'Hozier': 'Indie/Alternative',
    'Of Monsters and Men': 'Indie/Alternative', 'The Lumineers': 'Indie/Alternative',
    'Mumford & Sons': 'Folk/Acoustic', 'The Script': 'Rock',
    'Jeremy Messersmith': 'Indie/Alternative',
    'fujii Kaze': 'J-Pop/Anime', 'LiSA': 'J-Pop/Anime',
    'Kenshi Yonezu': 'J-Pop/Anime', 'Ado': 'J-Pop/Anime',
    'Adam Lambert': 'Rock', 'Adam Hicks': 'Pop',
    'Bridgit Mendler': 'Pop', 'Naomi Scott': 'Pop',
    'Hayley Kiyoko': 'Pop', 'Austin Mahone': 'Pop',
    'Colbie Caillat': 'Pop', 'Jason Mraz': 'Pop',
    'Demi Lovato': 'Pop', 'Johnny Cash': 'Country',
    'Chase Holfelder': 'Pop', 'Really Slow Motion': 'Soundtrack/Score',
    'Jacob Sartorius': 'Pop', 'Louis Cole': 'Electronic/Dance',
    'No Age': 'Indie/Alternative', 'Hudson Mohawke': 'Electronic/Dance',
    'Davis Gaines': 'Pop', 'Jordan Gagne': 'Indie/Alternative',
    'Katy Sky': 'Pop', 'Timeflies': 'Pop',
    'Anselmo Ralph': 'R&B/Soul', 'Amar Sehmbi': 'R&B/Soul',
    'Alice Chater': 'Pop', 'E-rotic': 'Electronic/Dance',
    'Gigi Lai': 'Pop', 'Zheng Bingbing': 'Pop',
    'Good Boy daisy': 'Pop', 'Sody': 'Pop',
    'Liu Huan': 'Pop', 'Ne-Yo': 'R&B/Soul', 'Ne-yo': 'R&B/Soul',
    'Ben Kidson': 'Pop', 'Skinny Living': 'Indie/Alternative',
    'Kevin Leonardo': 'Pop', 'Young Stoner Life': 'Rap/Hip-Hop',
    'Dave': 'Rap/Hip-Hop', 'Valgur': 'Latin',
    'AV!VA': 'Pop', 'Aviva Scott': 'Pop',
    'Car Seat Headrest': 'Indie/Alternative',
    'Kungs': 'Electronic/Dance', 'Cookin\' on 3 Burners': 'Jazz/Swing',
    'Iselin Solheim': 'Pop',
    'Terminite': 'Electronic/Dance', 'OTR': 'Electronic/Dance',
    'cloudfield': 'Electronic/Dance',
    'Knives At Sea': 'Rock', 'Cody Lovass': 'Pop',
    'Calema': 'Latin', 'Chipettes': 'Soundtrack/Score',
    'Lxandra': 'Pop', 'Malinda': 'Pop',
    'Eliza Rickman': 'Indie/Alternative',
    'Seann Bowe': 'Pop', 'Maylyn': 'Pop',
    'Nurmat Sadyrov': 'Pop', 'Jem 77': 'Electronic/Dance',
    'SaraSinger42': 'Pop', 'Circuit des Yeux': 'Indie/Alternative',
    'Michele McLaughlin': 'Classical/Instrumental',
    'hiroshi sato': 'Soundtrack/Score',
    'DEELYLE': 'Electronic/Dance', 'CVX': 'Electronic/Dance',
    'Rever Mieux': 'Pop', 'Valeree': 'Pop', 'James Tw': 'Pop',
    'Tatsuya': 'J-Pop/Anime',
    'Yung Zel': 'Rap/Hip-Hop', 'Brictom': 'Electronic/Dance',
    'Clocks and Clouds': 'Soundtrack/Score',
    'IU': 'K-Pop', 'Zhou Shen': 'J-Pop/Anime',
    'Li Yigang': 'Pop', 'Xi Shua Shua': 'Pop',
    'Arthur Conti': 'Pop', 'Breath and Bone': 'Electronic/Dance',
    'Loco Loco': 'Latin', 'Sam Riegel': 'Soundtrack/Score',
    'Noah and The Arc': 'Indie/Alternative',
    'Damien Dawn': 'Electronic/Dance', 'DamienDawn': 'Electronic/Dance',
    'sixtynine': 'Electronic/Dance', 'Vairo': 'Electronic/Dance',
    'Runaground': 'Pop', 'Wicked': 'Soundtrack/Score',
    'Shi Shang Zhi You Mama Hao': 'Pop',
...
FAVORITE_ARTISTS: Dict[str, float] = {
    'Ariana Grande': 10.0,
    'Taylor Swift': 9.5,
    'Michael Jackson': 11.0,
    'Queen': 10.0,
    'Will Woods': 9.0,
    'Hoyo-Mix': 10.0,
    'Ado': 9.0,
    'Lindsey Stirling': 9.0,
